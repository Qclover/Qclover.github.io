...
![img1]({{site.baseurl}}/assets/images/images/phpyun-01.png)
...
![img2]({{site.baseurl}}/assets/images/images/phpyun-02.png)

以下是$mypath备份路径的参数传递过程，通过分析可以知道备份路径为bdata路径下写入的文件目录为bdata下的目录名为phpyun_2018+当前时间的目录写入数据的文件为config.php。

![img3]({{site.baseurl}}/assets/images/images/phpyun-03.png)
![img]({{site.baseurl}}/assets/images/images/phpyun-04.png)
![img4-mypath]({{site.baseurl}}/assets/images/images/phpyun-05.png)

复现：

登入后台进行数据备份抓包重放构造payload:xxxx];phpinfo();//成功写入了文件且导致代码执行发生

![img6]({{site.baseurl}}/assets/images/images/phpyun-06.png)

![img7]({{site.baseurl}}/assets/images/images/phpyun-07.png)

![img8]({{site.baseurl}}/assets/images/images/phpyun-08.png)
