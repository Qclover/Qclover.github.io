...
之前写过一个比较入门的[漏洞挖掘浅谈](http://qclover.cn/2019/05/02/SRC%E9%80%BB%E8%BE%91%E6%BC%8F%E6%B4%9E%E6%8C%96%E6%8E%98%E6%B5%85%E8%B0%88.html),而之后的漏洞挖掘和工作中的产品测试过程中除了白盒代码审计之外比较偏向黑盒测试/漏洞挖掘，那么我觉得漏洞挖掘/黑盒测试过程中的遇到过的一些fuzz技术思想有必要借用我遇到过的实战中的例子来归纳总结下，通过实例对fuzz的思想进行展开。
...
提交时，还有在上传中文件类型指定了excel、or word那么都可以进行Fuzz测试。关于XXE详细的利用可参考我之前的[**java审计之XXE**](http://qclover.cn/2019/11/14/PHP与JAVA之XXE漏洞详解与审计.html)记录了白盒审计及黑盒测试利用详细的过程。
